...
**v3.2.5** · Karpathy LLM-as-Compiler 패턴 실증 · macOS (Apple Silicon) · MIT license · 392 passed + 13 subtests
...
**392 passed + 13 subtests** (회귀 0, v3.2.6 기준 카운트). functional 전부 OK, v3.0.x 의 e2e perf 회귀 (avg 452ms > 150ms) 는 NEXT-27/28 fix 로 해소 (현재 p50=39ms). 네트워크/Gemma 불필요 (mocked).
